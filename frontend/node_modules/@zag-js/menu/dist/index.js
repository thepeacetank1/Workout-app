...
var getNextEl = (ctx, opts) => domQuery.nextById(getElements(ctx), opts.value, opts.loop ?? opts.loopFocus);
var getPrevEl = (ctx, opts) => domQuery.prevById(getElements(ctx), opts.value, opts.loop ?? opts.loopFocus);
var getElemByKey = (ctx, opts) => domQuery.getByTypeahead(getElements(ctx), {
...
var machine = core.createMachine({
  ...
  implementations: {
    guards: {
      ...
      isHighlightedItemEditable: ({ context, scope }) => domQuery.isEditableElement(getItemEl(scope, context.get("highlightedValue"))),
